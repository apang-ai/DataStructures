...
'''
    六、 快速排序
        选择一个值作为枢纽值，一半就是列表的第一项，枢纽值作为帮助拆分的标准
        alist = [54,26,93,17,77,31,44,55,20]
                [17, 20, 26, 31, 44, 54, 55, 77, 93]
        
        54 最终在原列表中31的位置上，这个位置叫做：拆分点
        54  左标记   [26,93,17,77,31,44,55,20]  右标记

        首先增加左标记，直到找到一个大于枢纽值，停止，然后递减右标记，直到找到一个小于枢纽值的值，停止，交换这两项
        ...
        交换
        第一次结果  [54, 26, 20, 17,77,31,44,55, 93]
        第二次      [54, 26, 20, 17,44,31,77,55, 93]
        第三次      [31, 26, 20, 17,44,54,77,55, 93]
